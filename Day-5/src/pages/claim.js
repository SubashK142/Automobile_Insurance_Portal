...
export default function Claim() {
  ...
  return (
    ...
    <h5 style={{padding:7,fontSize:20,marginTop:15,marginBottom:15,marginLeft:20,paddingLeft:60,backgroundColor:'#D9D9D9',color:'black',width:250,borderRadius:15}}>{id}</h5>
